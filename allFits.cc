...
//  RooPlot *frameSB = new RooPlot("frameSB", "frameSB", m_mumu, 1.5, 3.5, 800);
  ...
  sb_model1->plotOn(frameSB, RooFit::Name("single_exp"), RooFit::LineColor(kBlue), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  sb_model2->plotOn(frameSB, RooFit::Name("double_exp"), RooFit::LineColor(kRed), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  sb_model3->plotOn(frameSB, RooFit::Name("single_pow"), RooFit::LineColor(kGreen), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  sb_model4->plotOn(frameSB, RooFit::Name("poly2"), RooFit::LineColor(kYellow), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  sb_model5->plotOn(frameSB, RooFit::Name("poly3"), RooFit::LineColor(kMagenta), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  sb_model6->plotOn(frameSB, RooFit::Name("poly4"), RooFit::LineColor(kCyan), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
