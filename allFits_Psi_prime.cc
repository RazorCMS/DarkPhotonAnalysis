...
//void allFits(){
  ...
  */
  ...
  w1->pdf("sb_model")->plotOn(frameSB, RooFit::Name("single_exp"), RooFit::LineColor(kBlue), RooFit::Range("Psi_p"), RooFit::NormRange("Psi_p"));
  w2->pdf("sb_model")->plotOn(frameSB, RooFit::Name("double_exp"), RooFit::LineColor(kRed), RooFit::Range("Psi_p"), RooFit::NormRange("Psi_p"));
  w3->pdf("sb_model")->plotOn(frameSB, RooFit::Name("single_pow"), RooFit::LineColor(kGreen), RooFit::Range("Psi_p"), RooFit::NormRange("Psi_p"));
  w4->pdf("sb_model")->plotOn(frameSB, RooFit::Name("poly2"), RooFit::LineColor(kYellow), RooFit::Range("Psi_p"), RooFit::NormRange("Psi_p"));
  w5->pdf("sb_model")->plotOn(frameSB, RooFit::Name("poly3"), RooFit::LineColor(kMagenta), RooFit::Range("Psi_p"), RooFit::NormRange("Psi_p"));
  w6->pdf("sb_model")->plotOn(frameSB, RooFit::Name("poly4"), RooFit::LineColor(kCyan), RooFit::Range("Psi_p"), RooFit::NormRange("Psi_p"));
