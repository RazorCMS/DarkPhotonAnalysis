...
//void allFits(){
  ...
  TFile* f1 = new TFile("LowMassFits_single_exp.root") ;
  TFile* f2 = new TFile("LowMassFits_double_exp.root") ;
  TFile* f3 = new TFile("LowMassFits_single_pow.root") ;
  TFile* f4 = new TFile("LowMassFits_poly2.root") ;
  TFile* f5 = new TFile("LowMassFits_poly3.root") ;
  TFile* f6 = new TFile("LowMassFits_poly4.root") ;
...
/*
  RooRealVar m_mumu("mass2", "m_{#mu#mu}", 1, 10., "GeV");
...
//  RooPlot *frameSB = new RooPlot("frameSB", "frameSB", m_mumu, 1.5, 3.5, 800);
  ...
  w1->pdf("sb_model")->plotOn(frameSB, RooFit::Name("single_exp"), RooFit::LineColor(kBlue), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  w2->pdf("sb_model")->plotOn(frameSB, RooFit::Name("double_exp"), RooFit::LineColor(kRed), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  w3->pdf("sb_model")->plotOn(frameSB, RooFit::Name("single_pow"), RooFit::LineColor(kGreen), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  w4->pdf("sb_model")->plotOn(frameSB, RooFit::Name("poly2"), RooFit::LineColor(kYellow), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  w5->pdf("sb_model")->plotOn(frameSB, RooFit::Name("poly3"), RooFit::LineColor(kMagenta), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  w6->pdf("sb_model")->plotOn(frameSB, RooFit::Name("poly4"), RooFit::LineColor(kCyan), RooFit::Range("JPsi"), RooFit::NormRange("JPsi"));
  ...
  dcb1->plotOn(frameS, RooFit::Name("single_exp"), RooFit::LineColor(kRed), RooFit::Range("sig_plot"), RooFit::NormRange("sig_plot") );
  dcb2->plotOn(frameS, RooFit::Name("double_exp"), RooFit::LineColor(kBlue), RooFit::Range("sig_plot"), RooFit::NormRange("sig_plot") );
  dcb3->plotOn(frameS, RooFit::Name("single_pow"), RooFit::LineColor(kGreen), RooFit::Range("sig_plot"), RooFit::NormRange("sig_plot") );
  dcb4->plotOn(frameS, RooFit::Name("poly2"), RooFit::LineColor(kYellow), RooFit::Range("sig_plot"), RooFit::NormRange("sig_plot") );
  dcb5->plotOn(frameS, RooFit::Name("poly3"), RooFit::LineColor(kMagenta), RooFit::Range("sig_plot"), RooFit::NormRange("sig_plot") );
  dcb6->plotOn(frameS, RooFit::Name("poly4"), RooFit::LineColor(kCyan), RooFit::Range("sig_plot"), RooFit::NormRange("sig_plot") );
  ...
  cs->SetLogy();
  cs->Update();
  cs->SaveAs("allSigFits_JPsi_.png");
}
